...
public class ExportDeclarationMapToIE515bTest {
	...
	public void testConvert() {
		String fileNameInput = "src/main/resources/ExportDeclaration.xml";
		String fileNameOutput = "target/_ExportDeclarationMapToIE515b_result.xml";
