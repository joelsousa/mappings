...
public class IE560MapToDeclarationResponseTest {
	...
	public void testConvert() {
		String fileNameInput = "src/main/resources/IE560_ExportControlNotification.xml";
		String fileNameOutput = "target/_IE560MapToDeclarationResponse_result.xml";
		...
		try { // Mapping
			...
			IE560MapToDeclarationResponse messageObject = new IE560MapToDeclarationResponse();
