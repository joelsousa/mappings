...
public class IE509MapToCancellationResponseTest {
	...
	public void testConvert() {
		String fileNameInput = "src/main/resources/IE509_ExportCancellationDecision.xml";
		String fileNameOutput = "target/_IE509MapToCancellationResponse_result.xml";
		...
		try { // Mapping
			...
			IE509MapToCancellationResponse messageObject = new IE509MapToCancellationResponse();
