...
public class IM560MapToImportDeclarationResponseTest {
	...
	public void testConvert() {
		String fileNameInput = "src/main/resources/IM560_ImportControlDecisionNotification.xml";
		String fileNameOutput = "target/_IM560MapToImportDeclarationResponse_result.xml";
		...
		try { // Mapping
			...
			IM560MapToImportDeclarationResponse messageObject = new IM560MapToImportDeclarationResponse();
