...
public class TransactionAckMapToLocalAppResultTest {
	...
	public void testConvert() {
		String fileNameInput = "src/main/resources/ApiMessageAcknowledgmentExpired.xml";
		String fileNameOutput = "target/_TransactionAckExpired_result.xml";
		...
		try { // Mapping
			...
			TransactionAckMapToLocalAppResult messageObject = new TransactionAckMapToLocalAppResult();
