...
public class IM516MapToImportDeclarationResponseTest {
	...
	public void testConvert() {
		String fileNameInput = "src/main/resources/IM516_ImportDeclarationRejected.xml";
		String fileNameOutput = "target/_IM516MapToImportDeclarationResponse_result.xml";
		...
		try { // Mapping
			...
			ImportDeclarationMapToIM515 messageObject = new ImportDeclarationMapToIM515();
