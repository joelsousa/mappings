...
public class TechnicalErrorMapToErrorMessageTest {
	...
	public void testConvert() {
		String fileNameInput = "src/main/resources/IE599_ExportNotification.xml";
		String fileNameOutput = "target/_TechnicalErrorMapToErrorMessage_result.xml";
		...
		try { // Mapping
			...
			TechnicalErrorMapToErrorMessage messageObject = new TechnicalErrorMapToErrorMessage();
