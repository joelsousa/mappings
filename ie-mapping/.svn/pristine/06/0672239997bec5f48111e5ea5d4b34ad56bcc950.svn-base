...
public class CancellationMapToIE514Test {
	...
	public void testConvert() {
		...
		String fileNameOutput = "target/_CancellationMapToIE514_result.xml";
		...
		try { // Mapping
			...
			CancellationMapToIE514 messageObject = new CancellationMapToIE514();
