...
public class ApiMessageAcknowledgementMapTolocalAppResultTest {
	...
	public void testConvert() {
		String fileNameInput = "src/main/resources/ApiMessageAcknowledgmentRejected.xml";
		String fileNameOutput = "target/_ApiMessageAcknowledgmentRejected_result.xml";
		...
		try { // Mapping
			...
			ApiMessageAcknowledgementMapTolocalAppResult messageObject = new ApiMessageAcknowledgementMapTolocalAppResult();
		...
		try {
			...
			assertEquals("The value is not VALID", "REJECTED", textContent);
