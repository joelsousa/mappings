...
public class IM529MapToImportDeclarationDecisionTest {
	...
	public void testConvert() {
		String fileNameInput = "src/main/resources/IM529_ReleaseForImport.xml";
		String fileNameOutput = "target/_IM529MapToImportDeclarationDecision_result.xml";
		...
		try { // Mapping
			...
			IM529MapToImportDeclarationDecision messageObject = new IM529MapToImportDeclarationDecision();
