...
public class IM528MapToImportDeclarationResponseTest {
	...
	public void testConvert() {
		String fileNameInput = "src/main/resources/IM528_ImportMRNAllocated.xml";
		String fileNameOutput = "target/_IM528MapToImportDeclaration_result.xml";
		...
		try { // Mapping
			...
			IM528MapToImportDeclarationResponse messageObject = new IM528MapToImportDeclarationResponse();
