...
public class IE599MapToConfirmationTest {
	...
	public void testConvert() {
		...
		String fileNameOutput = "target/_IE599MapToconfirmation_result.xml";
		...
		try { // Mapping
			...
			IE599MapToConfirmation messageObject = new IE599MapToConfirmation();
