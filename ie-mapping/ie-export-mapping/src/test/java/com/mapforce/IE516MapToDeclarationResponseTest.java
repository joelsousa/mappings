...
public class IE516MapToDeclarationResponseTest {
	...
	public void testConvert() {
		...
		String fileNameOutput = "target/_IE516MapToExportDeclarationResponse_result.xml";
		...
		try { // Mapping
			...
			IE516MapToDeclarationResponse messageObject = new IE516MapToDeclarationResponse();
