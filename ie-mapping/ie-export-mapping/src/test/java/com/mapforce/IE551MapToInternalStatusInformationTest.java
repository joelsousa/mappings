...
public class IE551MapToInternalStatusInformationTest {
	...
	public void testConvert() {
		String fileNameInput = "src/main/resources/IE516_ExportDeclarationRejected.xml";
		String fileNameOutput = "target/_IE551MapToInternalStatusInformation_result.xml";
		...
		try { // Mapping
			...
			IE551MapToInternalStatusInformation messageObject = new IE551MapToInternalStatusInformation();
